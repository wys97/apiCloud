...
var MyPointList = function (_React$Component) {
  (0, _inherits3.default)(MyPointList, _React$Component);

  function MyPointList(props) {
    (0, _classCallCheck3.default)(this, MyPointList);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MyPointList.__proto__ || (0, _getPrototypeOf2.default)(MyPointList)).call(this, props));

    _this.getDate = function () {
      var that = _this;
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("pointsLogWeek"),
          method: "post",
          dataType: "json",
          headers: {
  ...
  (0, _createClass3.default)(MyPointList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("div", { style: { height: "46px", borderBottom: "1px solid #EFEFEF" } }),
        _react2.default.createElement(
          _list2.default,
          null,
...
MyPointList.displayName = "MyPointList";
MyPointList.propTypes = {};
MyPointList.defaultProps = {};
exports.default = MyPointList;


_reactDom2.default.render(_react2.default.createElement(MyPointList, null), document.getElementById("myPointList"));
