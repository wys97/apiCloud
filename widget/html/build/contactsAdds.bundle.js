...
var ContactsAdds = function (_React$Component) {
  (0, _inherits3.default)(ContactsAdds, _React$Component);

  function ContactsAdds(props) {
    (0, _classCallCheck3.default)(this, ContactsAdds);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ContactsAdds.__proto__ || (0, _getPrototypeOf2.default)(ContactsAdds)).call(this, props));
    ...
    _this.getAdd = function () {
      var data = [{
        contactType: "COMMON",
        contactRelation: _this.state.contactRelation1[0],
        contactName: _this.state.contactName1,
        contactPhone: _this.state.contactPhone1
      }, {
        contactType: "COMMON",
        contactRelation: _this.state.contactRelation2[0],
        contactName: _this.state.contactName2,
        contactPhone: _this.state.contactPhone2
      }];
      console.log("联系人：" + (0, _stringify2.default)(data));
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("contacInfoSaveBatch"),
          method: "post",
          dataType: "json",
          headers: {
        ...
        _contacts2.default.contactInfoSave(data).then(function (res) {
    ...
    _this.decide = function () {
      //不能为空
      if (_this.state.contactPhone1 !== "" && _this.state.contactRelation1 !== [] && _this.state.contactName1 !== "" && _this.state.contactPhone2 !== "" && _this.state.contactRelation2 !== [] && _this.state.contactName2 !== "") {
        _this.setState({
          disabled: false
        });
      } else {
    ...
    _this.contactPhone1 = function (value) {
      //常用联系人手机1
    ...
    _this.contactPhone2 = function (value) {
      //常用联系人手机2
      if (!/^[1](([3][0-9])|([4][5-9])|([5][0-3,5-9])|([6][5,6])|([7][0-8])|([8][0-9])|([9][1,8,9]))[0-9]{8}$/.test(value)) {
        _this.setState({
          hasError2: true,
    ...
    _this.dataOnChange1 = function (value) {
      //常营联系人关系1
      _this.setState({
    ...
    _this.dataOnChange2 = function (value) {
      //常营联系人关系2
      _this.setState({
    ...
    _this.contactNameChange1 = function (value) {
      //常营联系人姓名 1
      _this.setState({
        contactName1: value
      });
    ...
    _this.contactNameChange2 = function (value) {
      //常营联系人姓名 2
      _this.setState({
        contactName2: value
      });
  ...
  (0, _createClass3.default)(ContactsAdds, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.error2 === "" ? null : _react2.default.createElement(
          "p",
          { className: "error" },
          this.state.error2
        ),
        _react2.default.createElement(
          "div",
          { className: "hint" },
          "*\u8BF7\u5982\u5B9E\u586B\u5199\u8054\u7CFB\u4EBA\u4FE1\u606F\uFF0C\u81F3\u5C11\u586B\u51992\u4E2A\u8054\u7CFB\u4EBA\uFF0C\u5176\u4E2D\u4E00\u4EBA\u9700\u4E3A\u76F4\u7CFB\u4EB2\u5C5E\uFF0C\u5426\u5219\u4F1A\u5BFC\u81F4\u6388\u4FE1\u5BA1\u6838\u5931\u8D25\u3002"
        ),
        _react2.default.createElement(
          _button2.default,
...
ContactsAdds.displayName = "ContactsAdds";
ContactsAdds.propTypes = {};
ContactsAdds.defaultProps = {};
exports.default = ContactsAdds;


_reactDom2.default.render(_react2.default.createElement(ContactsAdds, null), document.getElementById("contactsAdds"));
