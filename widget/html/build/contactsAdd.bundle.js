...
var _contacts = __webpack_require__(229);
...
var ContactsAddForm = function (_React$Component) {
  (0, _inherits3.default)(ContactsAddForm, _React$Component);

  function ContactsAddForm(props) {
    (0, _classCallCheck3.default)(this, ContactsAddForm);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ContactsAddForm.__proto__ || (0, _getPrototypeOf2.default)(ContactsAddForm)).call(this, props));
    ...
    _this.getAdd = function () {
      var data = {
        contactType: "COMMON",
        contactRelation: _this.state.contactRelation[0],
      ...
      if (!window.api.pageParam.data) {
        //新增联系人
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("contacInfoSave"),
          method: "post",
          dataType: "json",
          headers: {
        ...
        //修改联系人
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("contacInfoUpdate"),
          method: "post",
          dataType: "json",
          headers: {
            "Content-Type": "application/json",
          ...
          data: {
            body: {
              contactType: _this.state.data.contactType,
              contactRelation: _this.state.contactRelation[0],
              contactName: _this.state.contactName,
              contactPhone: _this.state.contactPhone,
              contactId: _this.state.data.contactId
            }
          }
        }, function (res, err) {
          if (res.code == '200') {
        ...
        if (err) {
          _toast2.default.info(err.msg, 3);
        }
      }
    };
    ...
    _this.decide = function () {
      //不能为空
      if (_this.state.contactPhone !== "" && _this.state.contactRelation !== [] && _this.state.contactName !== "") {
        _this.setState({
          disabled: false
        });
      } else {
    ...
    _this.contactPhone = function (value) {
    ...
    _this.dataOnChange = function (value) {
      _this.setState({
    ...
    _this.contactNameChange = function (value) {
      _this.setState({
        contactName: value
      }, function () {
        _this.decide();
  ...
  (0, _createClass3.default)(ContactsAddForm, [{
    ...
    value: function componentWillMount() {
      ...
      window.apiready = function () {
        ...
        //页面传参
        if (window.api.pageParam.data) {
          console.log((0, _stringify2.default)(window.api.pageParam.data));
          that.setState({
            updata: true,
            disabled: false,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            mode: "light",
            icon: _react2.default.createElement(_icon2.default, { type: "left", color: "#444D54" }),
        ...
        _react2.default.createElement(
          _button2.default,
          { className: "next", disabled: this.state.disabled, onClick: this.getAdd },
          "\u4FDD\u5B58"
        )
      );
    }
  }]);
  return ContactsAddForm;
}(_react2.default.Component);

ContactsAddForm.displayName = "ContactsAdd";
ContactsAddForm.propTypes = {};
ContactsAddForm.defaultProps = {};
exports.default = ContactsAddForm;


var ContactsAdd = (0, _rcForm.createForm)()(ContactsAddForm);
_reactDom2.default.render(_react2.default.createElement(ContactsAdd, null), document.getElementById("contactsAdd"));
...
exports.creditApply = exports.contactInfoSave = exports.contactInfo = undefined;
 ...
 * 联系人列表
 */
var contactInfo = exports.contactInfo = function () {
...
var contactInfoSave = exports.contactInfoSave = function () {
  ...
  return function contactInfoSave() {
...
var creditApply = exports.creditApply = function () {
...
exports.default = {
  ...
  contactInfoSave: contactInfoSave,
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.contactsAdd {\n  position: relative;\n  background: #fff; }\n  .contactsAdd .am-navbar-right img {\n    height: 22px; }\n  .contactsAdd .am-list .am-list-header {\n    background: #F9FAF9; }\n  .contactsAdd .am-list .am-list-item {\n    height: 52px;\n    font-size: 14px; }\n    .contactsAdd .am-list .am-list-item .am-list-content {\n      color: #3f4850; }\n    .contactsAdd .am-list .am-list-item .am-list-extra {\n      color: #444d54; }\n    .contactsAdd .am-list .am-list-item .am-list-line {\n      font-size: 14px; }\n      .contactsAdd .am-list .am-list-item .am-list-line .am-input-label {\n        color: #3f4850; }\n      .contactsAdd .am-list .am-list-item .am-list-line .am-input-control input {\n        text-align: right;\n        color: #444d54; }\n  .contactsAdd .next {\n    display: block;\n    background: #e1514c;\n    height: 1.87733rem;\n    border: none;\n    border-radius: 16px 0 16px 0;\n    margin: 5.12rem 1.19467rem;\n    padding: 0.576rem 0;\n    color: #fff;\n    font-size: 17px;\n    line-height: 17px;\n    text-align: center; }\n  .contactsAdd .next::before {\n    border: none !important; }\n  .contactsAdd .am-button-disabled {\n    background: #BDBDBD; }\n\n.am-picker-popup-body .am-picker-popup-item {\n  color: #333333; }\n\n.relation b {\n  border: 1px solid #E1514C;\n  border-radius: 2px;\n  font-size: 10px;\n  color: #E1514C;\n  margin-right: 0.64rem;\n  display: inline-block;\n  height: 15px;\n  line-height: 15px;\n  width: 1.28rem;\n  text-align: center;\n  vertical-align: middle; }\n\n.relation i {\n  margin-left: 1.92rem; }\n\n.error {\n  color: #e1514c;\n  width: 100%;\n  text-align: center;\n  font-size: 14px;\n  margin-top: 0.21333rem; }\n\n.am-list-item .am-input-label, .am-list-item .am-list-line .am-list-content {\n  font-size: 14px; }\n\n.am-list-item .am-list-line .am-list-extra, .am-list-item .am-input-control input {\n  font-size: 14px; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444d54; }\n\n.am-list-item .am-list-line .am-list-extra {\n  -webkit-flex-basis: 36%;\n  -ms-flex-preferred-size: 36%;\n  flex-basis: 36%;\n  color: #BDBDBD !important;\n  font-size: 14px;\n  line-height: 1.5;\n  text-align: right;\n  width: 100%;\n  overflow: initial;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  padding-top: 5px;\n  padding-bottom: 7px; }\n\n.contactsAdd .am-list .am-list-item .am-list-line .am-input-control input {\n  height: 50px; }\n\n.hint {\n  color: #E0514C;\n  font-size: 12px;\n  padding: 10px 15px;\n  line-height: 17px; }\n", ""]);
