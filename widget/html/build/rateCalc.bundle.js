...
var _wingBlank = __webpack_require__(1014);

var _wingBlank2 = _interopRequireDefault(_wingBlank);

var _flex = __webpack_require__(1015);
...
var _rcForm = __webpack_require__(238);
...
var _rateCalc = __webpack_require__(1023);

var _rateCalc2 = _interopRequireDefault(_rateCalc);

var _down = __webpack_require__(1024);
...
var RateCalcForm = function (_React$Component) {
    (0, _inherits3.default)(RateCalcForm, _React$Component);

    function RateCalcForm(props) {
        (0, _classCallCheck3.default)(this, RateCalcForm);

        var _this = (0, _possibleConstructorReturn3.default)(this, (RateCalcForm.__proto__ || (0, _getPrototypeOf2.default)(RateCalcForm)).call(this, props));

        _this.changePrice = function (val) {
            if (val.indexOf('￥') !== -1) {
                _this.setState({
                    price: val
                });
        ...
        _this.toCompute = function () {
            var that = _this;
            var index = _.findIndex(_this.state.stages, function (obj) {
                return obj;
            });
            var data = {
                loanAmount: _this.state.price.substring(1),
            ...
            if (window.api) {
                _this.state.ajax({
                    url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("calculator"),
                    method: 'post',
                    headers: {
                    ...
                    if (err) {
                        _toast2.default.fail(err.body.message, 3);
                        return;
                    }
                    var res = { data: ret.body };
                    if (res.data.code !== '200') {
                        _toast2.default.fail(res.data.message, 3);
                        return;
                    }
                    that.setState({
            ...
            _rateCalc2.default.toCompute(data).then(function (res) {
                if (res.data.code !== '200') {
                    _toast2.default.fail(res.data.message, 3);
                    return;
                }
    ...
    (0, _createClass3.default)(RateCalcForm, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'rateCalc', style: { minHeight: '100%', backgroundColor: '#F9FAF9' } },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _inputItem2.default,
                            (0, _extends3.default)({}, getFieldProps('autofocus'), {
                                type: 'money',
                                maxLength: 8,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    _flex2.default,
                                    null,
                                    this.state.stages.map(function (item, idx) {
                                        return _react2.default.createElement(
                                            _flex2.default.Item,
                                            { key: idx },
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    _button2.default,
                                                    {
                                                        style: item ? {
                                                            ...
                                                            var stages = new Array(5).fill(false);
                                                            stages[idx] = true;
                                                            _this2.setState({
                                                                stages: stages
                                                            });
                        ...
                        _react2.default.createElement(
                            Item,
                            { extra: '等额本息', style: { borderBottom: '2px solid #F4F4F4' } },
                            '\u8FD8\u6B3E\u65B9\u5F0F'
                        )
                    )
                ),
                ...
                this.state.computeList.length ? _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement('img', { src: _down2.default, alt: '', style: { width: '17px', margin: '0 auto' } }),
                        _react2.default.createElement(
                            _wingBlank2.default,
                            null,
                            _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _wingBlank2.default,
                        null,
                        this.state.computeList.map(function (item, idx) {
                            return _react2.default.createElement(
                                'div',
                                { key: idx, style: { height: '74px', borderBottom: '1px solid #EDEDED' } },
                                _react2.default.createElement(
                                    _flex2.default,
                                    null,
                                    _react2.default.createElement(
                                        _flex2.default.Item,
                                        { style: { width: '20%', flex: 'auto' } },
                                        _react2.default.createElement(
                                            'div',
                                            { style: { height: '74px', lineHeight: '74px' } },
                                            item.periodNo
                                        )
                                    ),
                                    _react2.default.createElement(
                ...
                _react2.default.createElement('div', { style: { height: '95px' } }),
                _react2.default.createElement(
                    'div',
                    { style: {
                    ...
                    _react2.default.createElement(
                        _navBar2.default,
                        {
                            style: (0, _stringify2.default)(this.state.stages).indexOf('true') !== -1 && this.state.price.length > 1 ? {
                            ...
                            mode: 'dark',
                            onClick: (0, _stringify2.default)(this.state.stages).indexOf('true') !== -1 && this.state.price.length > 1 ? this.toCompute : function () {}
                        },
                        '\u8BA1\u7B97'
                    )
                )
...
RateCalcForm.displayName = 'RateCalc';
RateCalcForm.propTypes = {};
RateCalcForm.defaultProps = {};


var RateCalc = (0, _rcForm.createForm)()(RateCalcForm);
_reactDom2.default.render(_react2.default.createElement(RateCalc, null), document.getElementById('rate'));
...
var _Flex = __webpack_require__(1016);

var _Flex2 = _interopRequireDefault(_Flex);

var _FlexItem = __webpack_require__(1017);
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept(472, function() {
			var newContent = __webpack_require__(472);
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(473, function() {
			var newContent = __webpack_require__(473);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
 ...
 * 计算
 */
var toCompute = exports.toCompute = function () {
...
module.exports = "data:image/png;base64,"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hoist_non_react_statics__ = __webpack_require__(309);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createForm__ = __webpack_require__(239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createFormField__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__propTypes__ = __webpack_require__(310);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBaseForm__ = __webpack_require__(240);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__(204);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_toConsumableArray__ = __webpack_require__(236);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_create_react_class__ = __webpack_require__(241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_async_validator__ = __webpack_require__(242);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_warning__ = __webpack_require__(186);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_get__ = __webpack_require__(264);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lodash_set__ = __webpack_require__(190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_lodash_eq__ = __webpack_require__(157);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__createFieldsStore__ = __webpack_require__(308);
...
var _messages2 = __webpack_require__(263);
...
var _method = __webpack_require__(250);

var _method2 = _interopRequireDefault(_method);

var _number = __webpack_require__(251);

var _number2 = _interopRequireDefault(_number);

var _boolean = __webpack_require__(252);

var _boolean2 = _interopRequireDefault(_boolean);

var _regexp = __webpack_require__(253);

var _regexp2 = _interopRequireDefault(_regexp);

var _integer = __webpack_require__(254);

var _integer2 = _interopRequireDefault(_integer);

var _float = __webpack_require__(255);
...
var _enum = __webpack_require__(258);

var _enum2 = _interopRequireDefault(_enum);

var _pattern = __webpack_require__(259);
...
var _required = __webpack_require__(185);
...
var Symbol = __webpack_require__(153),
    arrayMap = __webpack_require__(302),
...
var assignValue = __webpack_require__(304),
    castPath = __webpack_require__(187),
...
var baseAssignValue = __webpack_require__(305),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_set__ = __webpack_require__(190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__createFormField__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils__ = __webpack_require__(192);
 ...
 */
var ReactIs = __webpack_require__(340);
var REACT_STATICS = {
...
var _whitespace = __webpack_require__(245);
...
var _range = __webpack_require__(247);

var _range2 = _interopRequireDefault(_range);

var _enum = __webpack_require__(248);

var _enum2 = _interopRequireDefault(_enum);

var _pattern = __webpack_require__(249);
...
// module
exports.push([module.i, ".rateCalc .am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.rateCalc .am-list .am-list-body::after {\n  height: 0 !important; }\n\n.rateCalc .am-list .am-list-body .am-list-item {\n  min-height: 74px; }\n  .rateCalc .am-list .am-list-body .am-list-item.tags .am-list-line {\n    padding-right: 0; }\n  .rateCalc .am-list .am-list-body .am-list-item.tags .am-list-item .am-list-item-middle .am-list-line {\n    border-bottom: 3px solid #F2F2F2; }\n  .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-input-label {\n    font-size: 14px;\n    color: #3F4850; }\n    .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-input-label.am-input-label-5 {\n      width: 100px; }\n  .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-input-control input {\n    color: #444D54;\n    font-size: 30px; }\n  .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-input-control .fake-input-container .fake-input {\n    font-size: 30px; }\n  .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-list-content {\n    font-size: 14px;\n    color: #3F4850; }\n    .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-list-content .am-list-brief .am-flexbox-item .am-button {\n      height: 36px;\n      line-height: 36px;\n      border: 1px solid #ddd;\n      border-radius: 2px; }\n      .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-list-content .am-list-brief .am-flexbox-item .am-button::before {\n        border: none; }\n  .rateCalc .am-list .am-list-body .am-list-item .am-list-line .am-list-extra {\n    font-size: 14px;\n    color: #3F4850; }\n  .rateCalc .am-list .am-list-body .am-list-item .am-list-line-multiple .am-list-content {\n    padding-top: 14px;\n    padding-bottom: 9px; }\n", ""]);
