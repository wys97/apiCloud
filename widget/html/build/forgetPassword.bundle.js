...
var ForgetPassword = function (_React$Component) {
  (0, _inherits3.default)(ForgetPassword, _React$Component);

  function ForgetPassword(props) {
    (0, _classCallCheck3.default)(this, ForgetPassword);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ForgetPassword.__proto__ || (0, _getPrototypeOf2.default)(ForgetPassword)).call(this, props));
    ...
    _this.identityNoChange = function (value) {
      if (value.length === 18) {
        _this.setState({
          identityNo: value,
          disabled: false
    ...
    _this.next = function () {
      ...
      _this.setState({
        type: "authCode",
        disabled: true,
        phone: _this.state.phone.replace(/\s/g, '')
      });
      _this.getCode();
    };
    ...
    _this.getCode = function () {
      ...
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("sendCode"),
          method: "post",
          dataType: "json",
          headers: {
    ...
    _this.authCode = function () {
      ...
      window.api.ajax({
        url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("vaildCmsCode"),
        method: "post",
        dataType: "json",
        headers: {
          "Content-Type": "application/json"
    ...
    _this.idCard = function () {
      var that = _this;
      var from = window.api.pageParam.from;
      window.api.ajax({
        url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("verifyIdentity"),
        method: "post",
        dataType: "json",
        headers: {
          "Content-Type": "application/json"
  ...
  (0, _createClass3.default)(ForgetPassword, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.type === "set" ? _react2.default.createElement(
          "div",
          { className: "set" },
          _react2.default.createElement(
            _list2.default,
        ...
        ) : this.state.type === "authCode" ? _react2.default.createElement(
          "div",
          { className: "authCode" },
          _react2.default.createElement(
            _list2.default,
        ...
        ) : this.state.type === "idCard" ? _react2.default.createElement(
          "div",
          { className: "idCard" },
          _react2.default.createElement(
            _list2.default,
...
_reactDom2.default.render(_react2.default.createElement(ForgetPassword, null), document.getElementById("forgetPassword"));
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept(579, function() {
			var newContent = __webpack_require__(579);
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.forgetPassword .set .am-list-body .am-list-item .am-list-line .am-input-label {\n  color: #454f55; }\n\n.forgetPassword .set .am-list-body .am-list-item .am-list-line .am-input-control input {\n  text-align: right; }\n\n.forgetPassword .set .am-list-body::after {\n  width: 14.67733rem;\n  margin: 0 0.64rem; }\n\n.forgetPassword .authCode p {\n  line-height: 52px;\n  margin: 0 0.768rem;\n  font-size: 17px;\n  color: #454f55; }\n\n.forgetPassword .authCode .am-list-body .am-list-item .am-list-line .am-input-label {\n  color: #454f55;\n  width: 0; }\n  .forgetPassword .authCode .am-list-body .am-list-item .am-list-line .am-input-label .coundDown {\n    width: 3.41333rem;\n    height: 30px;\n    position: absolute;\n    right: 15px;\n    top: 13px;\n    border: 1px solid #e0514c;\n    border-radius: 4px;\n    color: #e0514c;\n    text-align: center; }\n    .forgetPassword .authCode .am-list-body .am-list-item .am-list-line .am-input-label .coundDown span {\n      display: block;\n      font-size: 14px;\n      line-height: 30px; }\n\n.forgetPassword .authCode .am-list-body::after {\n  width: 14.67733rem;\n  margin: 0 0.64rem; }\n\n.forgetPassword .next {\n  display: block;\n  background: #e1514c;\n  height: 1.87733rem;\n  border: none;\n  border-radius: 16px 0 16px 0;\n  padding: 0.576rem 0;\n  margin: 5.16267rem 1.19467rem 0 1.19467rem;\n  color: #fff;\n  font-size: 17px;\n  line-height: 17px;\n  text-align: center; }\n\n.forgetPassword .next::before {\n  border: none !important; }\n\n.forgetPassword .am-button-disabled {\n  background: white; }\n\n.forgetPassword .error {\n  color: #e1514c;\n  width: 100%;\n  text-align: center;\n  font-size: 14px;\n  margin-top: 0.21333rem; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444d54;\n  font-size: 17px; }\n\n.am-list-item .am-list-line .am-list-content,\n.am-list-item .am-input-label,\n.am-list-item .am-list-line .am-list-extra,\n.am-list-item .am-input-control input {\n  font-size: 14px; }\n\n.forgetPassword .set .am-list-body .am-list-item .am-list-line .am-input-control input {\n  margin: 0px -12px;\n  color: #444d54; }\n\n.am-list-item.am-input-item {\n  height: 56px; }\n  .am-list-item.am-input-item .am-input-clear {\n    width: 16px;\n    height: 16px;\n    background-size: 23px 21px;\n    background-position: -1px 0px; }\n\n.forgetPassword .authCode .am-list-body .am-list-item .am-list-line .am-input-label .coundDown span {\n  background: white; }\n\nhtml:not([data-scale]) .am-list-body div:not(:last-child) .am-list-line {\n  border-top: 1px solid #FAFAFA; }\n", ""]);
