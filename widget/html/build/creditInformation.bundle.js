...
var CreditInformation = function (_React$Component) {
  (0, _inherits3.default)(CreditInformation, _React$Component);

  function CreditInformation(props) {
    (0, _classCallCheck3.default)(this, CreditInformation);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CreditInformation.__proto__ || (0, _getPrototypeOf2.default)(CreditInformation)).call(this, props));
    ...
    _this.getDate = function () {
      ...
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("areaInfo"),
          method: "post",
          dataType: "json",
          headers: {
    ...
    _this.decide = function () {
      //不能为空
      if (_this.state.house !== "" && _this.state.email !== "" && _this.state.income !== "" && _this.state.houseAddress.length > 5 && _this.state.companyName !== '') {
        _this.setState({
          disabled: false
        });
      } else {
    ...
    _this.emailOnChange = function (value) {
    ...
    _this.incomeOnChange = function (value) {
      _this.setState({
        income: value
      });
      _this.decide();
    ...
    _this.companyNameOnChange = function (value) {
      if (value) {
        _this.setState({
          companyName: value
        });
        var strlen = _this.chkstrlen(value);
        if (strlen >= 8) {
          _this.decide();
        } else {
          _this.setState({
    ...
    _this.houseAddressOnChange = function (value) {
      if (value.length >= 6) {
        _this.setState({
          houseAddress: value,
          addressError: "",
    ...
    _this.submit = function () {
      var data = {
        ...
        houseProvinceNo: _this.state.house[0],
        houseCityNo: _this.state.house[1],
        houseAreaNo: _this.state.house[2],
        houseAddress: _this.state.houseAddress,
        email: _this.state.email,
        incomeMonth: _this.state.income[0]
      };
      window.api.ajax({
        url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("basicInfoSave"),
        method: "post",
        dataType: "json",
        headers: {
          "Content-Type": "application/json",
  ...
  (0, _createClass3.default)(CreditInformation, [{
    ...
    value: function render() {
      ...
      var strlen = this.chkstrlen(this.state.companyName);
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          strlen >= 8 || strlen == 0 ? null : _react2.default.createElement(
            "p",
            { className: "error" },
            "\u81F3\u5C114\u4E2A\u4E2D\u6587\u5B57\u7B26\u62168\u4E2A\u5B57\u7B26\uFF01"
          ),
          ...
          this.state.addressError === "" ? null : _react2.default.createElement(
            "p",
            { className: "error" },
...
CreditInformation.displayName = "CreditInformation";
CreditInformation.propTypes = {};
CreditInformation.defaultProps = {};
exports.default = CreditInformation;

_reactDom2.default.render(_react2.default.createElement(CreditInformation, null), document.getElementById("creditInformation"));
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.creditInformation {\n  position: relative; }\n  .creditInformation .am-list .am-list-item {\n    height: 52px;\n    font-size: 14px; }\n    .creditInformation .am-list .am-list-item .am-list-content {\n      color: #3f4850; }\n    .creditInformation .am-list .am-list-item .am-list-extra {\n      color: #444d54; }\n    .creditInformation .am-list .am-list-item .am-list-line {\n      font-size: 14px; }\n      .creditInformation .am-list .am-list-item .am-list-line .am-input-label {\n        color: #3f4850; }\n      .creditInformation .am-list .am-list-item .am-list-line .am-input-control input {\n        text-align: right;\n        color: #444d54; }\n  .creditInformation .next {\n    display: block;\n    background: #e1514c;\n    height: 1.87733rem;\n    border: none;\n    border-radius: 16px 0 16px 0;\n    padding: 0.576rem 0;\n    margin: 5.12rem 1.19467rem;\n    color: #fff;\n    font-size: 17px;\n    line-height: 17px;\n    text-align: center; }\n  .creditInformation .next::before {\n    border: none !important; }\n  .creditInformation .am-button-disabled {\n    background: #bdbdbd; }\n  .creditInformation .error {\n    color: #e1514c;\n    width: 100%;\n    text-align: center;\n    font-size: 14px;\n    margin-top: 0.21333rem; }\n\n.am-list-item .am-list-line .am-list-content,\n.am-list-item .am-input-label,\n.am-list-item .am-list-line .am-list-extra,\n.am-list-item .am-input-control input {\n  font-size: 14px; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444d54;\n  font-size: 17px; }\n", ""]);
