...
var FaceRecognition = function (_React$Component) {
  (0, _inherits3.default)(FaceRecognition, _React$Component);

  function FaceRecognition(props) {
    (0, _classCallCheck3.default)(this, FaceRecognition);

    var _this = (0, _possibleConstructorReturn3.default)(this, (FaceRecognition.__proto__ || (0, _getPrototypeOf2.default)(FaceRecognition)).call(this, props));

    _this.toAliveCheck = function () {

      var that = _this;
      var permission = _this.state.hasPermission && _this.state.hasPermission({ list: ["camera"] });
      if (permission[0].granted) {
        // 调用
        _this.setState({ animating: true });
        _this.state.liveDetectModule && _this.state.liveDetectModule.start(function (ret, err) {
          window.api.ajax({
            url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("authFace"),
            method: "post",
            dataType: "json",
            headers: {
            ...
            if (ret.code === "200") {
              ...
              window.api.ajax({
                ...
                if (res.code === "200") {
                  (0, _loginToken.setH5Token)(res.data);
                  ...
                  // } else 
                  if (ret.data.creditCash == 'HAVE_CREDIT' && ret.data.cashSync || ret.data.creditCash == 'CREDIT_EXPIRED' && ret.data.cashSync) {
                    //是否有授信 
                  ...
                  } else if (ret.data.creditHra == 'HAVE_CREDIT' && ret.data.hraSync || ret.data.creditHra == 'CREDIT_EXPIRED' && ret.data.hraSync) {
                    //嗨贷以授信，且第一次打开显示弹窗
              ...
              if (err) {
                console.log("报错:" + (0, _stringify2.default)(err));
        ...
        alert("权限申请", '为保证您正常地使用此功能，需要获取您的相机使用权限，请允许。', [{
          text: "返回", onPress: function onPress() {
            _this.setState({
              animating: false
            });
          }
          ...
          onPress: function onPress() {
            ...
            _this.state.requestPermission && _this.state.requestPermission({ list: ["camera"], code: 1 }, function (ret) {});
          }
        }]);
      }
    };

    _this.criteria = function (agreementBindCard, bindRepayBankCard, bankCardNo) {
      //没有绑定还款账号
  ...
  (0, _createClass3.default)(FaceRecognition, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var that = this;
      window.apiready = function () {
        var liveDetectModule = window.api.require("liveDetectModule");
        var hasPermission = window.api.hasPermission; // 相机权限检查
        var requestPermission = window.api.requestPermission;
        that.setState({
          liveDetectModule: liveDetectModule,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "logo" },
          _react2.default.createElement("img", { src: __webpack_require__(1071) }),
          _react2.default.createElement(
            "p",
            null,
            "\u4E3A\u4E86\u4FDD\u969C\u60A8\u7684\u8D44\u91D1\u5B89\u5168"
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("img", { src: __webpack_require__(1072), alt: "" }),
                _react2.default.createElement(
                  "p",
                  null,
                  "\u4E0D\u80FD\u4F4E\u5934\u4EF0\u62CD"
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("img", { src: __webpack_require__(1073), alt: "" }),
                _react2.default.createElement(
                  "p",
                  null,
                  "\u4E0D\u80FD\u906E\u6321\u8138\u90E8"
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("img", { src: __webpack_require__(1074), alt: "" }),
                _react2.default.createElement(
                  "p",
                  null,
                  "\u773C\u955C\u4E0D\u80FD\u53CD\u5149"
...
_reactDom2.default.render(_react2.default.createElement(FaceRecognition, null), document.getElementById("faceRecognition"));
...
module.exports = __webpack_require__.p + "4a2f475eb8f43ba867e09e5975cde0d4.png";
...
module.exports = __webpack_require__.p + "62befedff6cd96d0dcde298630eb16ac.png";
...
module.exports = __webpack_require__.p + "552a5394a276eace4256ad7eea669554.png";
...
module.exports = __webpack_require__.p + "94b15ff8e6fb353d072539622ac2671a.png";
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.faceRecognition .logo img {\n  width: 8.576rem;\n  margin: 2.304rem 3.712rem 1.36533rem 3.712rem;\n  display: block; }\n\n.faceRecognition .logo p {\n  font-size: 16px;\n  color: #444d54;\n  letter-spacing: -0.39px;\n  text-align: center;\n  line-height: 22px; }\n\n.faceRecognition .logo .hint {\n  display: flex;\n  justify-content: space-around;\n  margin-top: 2.98667rem; }\n  .faceRecognition .logo .hint li div {\n    display: flex;\n    flex-direction: column; }\n    .faceRecognition .logo .hint li div img {\n      display: block;\n      width: 2.47467rem;\n      height: 2.47467rem;\n      margin: 0 auto; }\n    .faceRecognition .logo .hint li div p {\n      font-size: 14px;\n      line-height: 20px;\n      color: #444d54;\n      margin-top: 0.55467rem;\n      letter-spacing: -0.34px;\n      text-align: center; }\n\n.faceRecognition .next {\n  display: block;\n  background: #e1514c;\n  width: 13.61067rem;\n  height: 1.87733rem;\n  border: none;\n  border-radius: 16px 0 16px 0;\n  padding: 0.576rem 0;\n  position: absolute !important;\n  left: 28px;\n  bottom: 26px;\n  color: #fff;\n  font-size: 17px;\n  line-height: 17px;\n  text-align: center; }\n\n.faceRecognition .next::before {\n  border: none !important; }\n\n.faceRecognition .am-button-disabled {\n  background: #bdbdbd; }\n\n.faceRecognition .am-activity-indicator-content {\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0);\n  border-radius: 0px; }\n\n.faceRecognition .am-activity-indicator-spinner {\n  background-image: url(" + escape(__webpack_require__(333)) + ");\n  width: 86px;\n  height: 86px;\n  background-size: 100%;\n  border-radius: 8px; }\n\n.loader_wrap {\n  width: 118px;\n  height: 118px;\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  margin: -47px 0 0 -59px;\n  border-radius: 14px;\n  background-color: #171717;\n  font-size: 14px;\n  display: flex;\n  flex-flow: column;\n  justify-content: center;\n  align-items: center; }\n\n.loader_img {\n  width: 25px;\n  height: 25px;\n  background-image: url(" + escape(__webpack_require__(334)) + ");\n  background-repeat: no-repeat;\n  background-size: cover;\n  margin-bottom: 10px; }\n\n.loader_text {\n  position: relative;\n  bottom: -26px;\n  color: #fff; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444d54;\n  font-size: 17px; }\n\n.am-modal-transparent {\n  width: 70%; }\n\n.am-modal-button-group-h .am-modal-button {\n  font-size: 16px; }\n", ""]);
