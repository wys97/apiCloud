...
var AddBankCardForm = function (_React$Component) {
  (0, _inherits3.default)(AddBankCardForm, _React$Component);

  function AddBankCardForm(props) {
    (0, _classCallCheck3.default)(this, AddBankCardForm);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddBankCardForm.__proto__ || (0, _getPrototypeOf2.default)(AddBankCardForm)).call(this, props));

    _this.getDate = function () {
      var that = _this;
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("getCustomerInfo"),
          method: "get",
          dataType: "json",
          headers: {
          ...
          if (ret) {
            ...
            (0, _toast2.default)(ret.message, 3);
          }
          that.refresh();
        });
      }
    ...
    _this.setCardNo = function (value) {
      if (!/^[0-9]{4}[ ]{1}[0-9]{4}[ ]{1}...$/.test(value)) {
        _this.setState({
          disabled: false,
          cardNo: value
        });
    ...
    _this.phoneVerification = function () {
      if (_this.state.cardNo.replace(/\s*/g, '').length - 1 < 15) {
        _toast2.default.info("请输入15-20位阿拉伯数字银行卡号", 4);
      } else {
        var that = _this;
        var cardNo = that.state.cardNo.replace(/\s*/g, "");
        if (window.api) {
          window.api.ajax({
            url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("cardBin") + cardNo,
            method: "get",
            dataType: "json",
            headers: {
              "Content-Type": "application/json",
            ...
            if (ret.code === "200") {
              ...
              window.api.openFrame({
                ...
                pageParam: (0, _extends3.default)({}, ret.data),
                rect: {
                  w: "auto",
                  marginTop: window.api.safeArea.top,
                  marginBottom: window.api.safeArea.bottom
    ...
    _this.openTips = function () {
      operation([{ text: "开始拍摄", onPress: function onPress() {
          return _this.getCamera("camera");
        } }, { text: "打开相册", onPress: function onPress() {
          return _this.getAlbum("album");
        } }]
    ...
    _this.getCamera = function (str, type) {
      //调用相机
      var hasPermission = _this.state.hasPermission && _this.state.hasPermission({ list: ["camera"] });
    ...
    _this.uploadImg = function (str) {
      ...
      window.api.getPicture({
        ...
        if (ret) {
          var data = ret.base64Data;
          var base64Data = data.substr(data.indexOf(',') + 1);
          window.api.ajax({
            url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("ocrBankCard"),
            method: "post",
            dataType: "json",
            headers: {
              "Content-Type": "application/json",
  ...
  (0, _createClass3.default)(AddBankCardForm, [{
    ...
    value: function render() {
      ...
      var identityNo = detail.identityNo && detail.identityNo.substring(0, 4) + '****' + detail.identityNo.substring(detail.identityNo.length - 4);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("img", {
              ...
              src: __webpack_require__(1034),
              alt: "",
              onClick: function onClick() {
                _this2.goSupportBank();
              }
            }),
            _react2.default.createElement("img", {
              className: "ocr",
  ...
  return AddBankCardForm;
}(_react2.default.Component);

AddBankCardForm.displayName = "AddBankCard";
AddBankCardForm.propTypes = {};
AddBankCardForm.defaultProps = {};
exports.default = AddBankCardForm;

var AddBankCard = (0, _rcForm.createForm)()(AddBankCardForm);
_reactDom2.default.render(_react2.default.createElement(AddBankCard, null), document.getElementById("addBankCard"));
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "d0e3aa5cda7e737e3f3f46ff4909832c.png";
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.addBankCard .pick-list .am-list-item .am-list-content {\n  color: #3f4850; }\n\n.addBankCard .pick-list .am-list-item .am-list-extra {\n  color: #444d54; }\n\n.addBankCard .pick-list .am-list-item .am-list-line .am-input-label {\n  color: #3f4850; }\n\n.addBankCard .pick-list .am-list-item .am-input-control {\n  color: #bdbdbd;\n  letter-spacing: -0.34px; }\n  .addBankCard .pick-list .am-list-item .am-input-control input {\n    text-align: right;\n    color: #444d54; }\n\n.addBankCard .am-list-body .bankCard .am-list-line {\n  position: relative;\n  height: 52px; }\n  .addBankCard .am-list-body .bankCard .am-list-line .am-input-label .ocr {\n    position: absolute;\n    right: 40px;\n    top: 14px;\n    width: 0.768rem;\n    height: 0.68267rem; }\n  .addBankCard .am-list-body .bankCard .am-list-line .am-input-label .supportBank {\n    position: absolute;\n    top: 14px;\n    right: 10px;\n    width: 0.68267rem;\n    height: 0.71133rem; }\n  .addBankCard .am-list-body .bankCard .am-list-line .am-input-clear {\n    width: 16px;\n    height: 16px;\n    margin-right: 56px;\n    background-size: 23px 21px;\n    background-position: -1px 0px;\n    margin-top: -8px; }\n\n.addBankCard .am-list-body .bankCard .am-input-control {\n  margin-right: 10px;\n  color: #bdbdbd;\n  letter-spacing: -0.34px; }\n  .addBankCard .am-list-body .bankCard .am-input-control input {\n    color: #444d54;\n    margin-bottom: 2px; }\n\n.addBankCard .next {\n  display: block;\n  background: #e1514c;\n  height: 1.87733rem;\n  border: none;\n  border-radius: 16px 0 16px 0;\n  padding: 0.576rem 0;\n  color: #fff;\n  font-size: 17px;\n  line-height: 17px;\n  text-align: center;\n  margin: 5.54667rem 1.19467rem; }\n\n.addBankCard .next::before {\n  border: none !important; }\n\n.addBankCard .am-button-disabled {\n  background: #BDBDBD; }\n\n.addBankCard .caution {\n  color: #e0514c;\n  margin-top: 9px;\n  margin-left: 16px;\n  font-size: 12px;\n  line-height: 17px; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444d54;\n  font-size: 17px; }\n\n.am-list-item .am-list-line .am-list-content, .am-list-item .am-input-label {\n  font-size: 14px;\n  color: #454F55; }\n\n.addBankCard .am-list-body .bankCard .am-list-line {\n  position: relative;\n  display: flex;\n  align-items: center; }\n\n.am-list-item .am-input-control input {\n  font-size: 14px; }\n\n.am-list-item.am-list-item-middle .am-list-line {\n  height: 52px; }\n", ""]);
