...
var CreditResult = function (_React$Component) {
  (0, _inherits3.default)(CreditResult, _React$Component);

  function CreditResult(props) {
    (0, _classCallCheck3.default)(this, CreditResult);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CreditResult.__proto__ || (0, _getPrototypeOf2.default)(CreditResult)).call(this, props));
    ...
    _this.getDate = function () {
      ...
      that.refresh();
      window.api.ajax({
        url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("creditApply"),
        method: "post",
        dataType: "json",
        headers: {
          "Content-Type": "application/json",
        ...
        console.log("授信结果" + (0, _stringify2.default)(ret));
        that.setState({
          animating: false
        });
        if (ret.code === "200") {
    ...
    _this.getOk = function () {
      console.log("是否有支付密码" + _this.state.setPaymentPwd);
      if (_this.state.setPaymentPwd === false) {
        alert('设置交易密码', _react2.default.createElement(
          "div",
          null,
          ...
          text: '暂不设置', onPress: function onPress() {
          ...
          text: '去设置', onPress: function onPress() {
            _this.toLink("设置支付密码");
            window.api.closeFrame({ name: "hnaIous" });
            window.api.closeFrame({ name: "idcardDiscern" });
            window.api.closeFrame({ name: "faceRecognition" });
    ...
    _this.toLink = function (menuName) {
      ...
      var link = url + "?token=" + window.localStorage.h5Token + "&channel=cashLoanApp&setType=credit";
  ...
  (0, _createClass3.default)(CreditResult, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var that = this;
      window.apiready = function () {
        that.getDate();
        console.log((0, _stringify2.default)(window.api.frames()));
      };
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "p",
            null,
            "\u5BA1\u6838\u7ED3\u679C\u9884\u8BA1\u4F1A\u57283\u4E2A\u5DE5\u4F5C\u65E5\u5185\u4EE5\u77ED\u4FE1\u5F62\u5F0F\u53D1\u9001\u7ED9\u60A8\uFF0C",
            _react2.default.createElement("br", null),
            "\u60A8\u4E5F\u53EF\u4EE5\u901A\u8FC7\u201C\u822A\u65C5\u5206\u671F\u201DAPP\u67E5\u8BE2\u989D\u5EA6\u4FE1\u606F"
          )
        ),
        _react2.default.createElement(
          _button2.default,
          { className: "next", onClick: this.getOk },
          "\u5B8C\u6210"
        ),
...
CreditResult.displayName = "CreditResult";
CreditResult.propTypes = {};
CreditResult.defaultProps = {};
exports.default = CreditResult;

_reactDom2.default.render(_react2.default.createElement(CreditResult, null), document.getElementById("creditResult"));
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept(561, function() {
			var newContent = __webpack_require__(561);
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.creditResult .succeed {\n  border-top: 1px solid #efefef; }\n  .creditResult .succeed img {\n    display: block;\n    width: 2.64533rem;\n    height: 2.64533rem;\n    margin: 3.41333rem 0 1.024rem 6.656rem; }\n  .creditResult .succeed h2 {\n    font-size: 16px;\n    color: #606060;\n    letter-spacing: -0.39px;\n    text-align: center;\n    line-height: 22px;\n    margin-bottom: 12px; }\n  .creditResult .succeed p {\n    font-size: 14px;\n    color: #909090;\n    letter-spacing: -0.34px;\n    text-align: center;\n    line-height: 20px; }\n\n.creditResult .next {\n  display: block;\n  background: #e1514c;\n  width: 13.61067rem;\n  height: 1.87733rem;\n  border: none;\n  border-radius: 16px 0 16px 0;\n  padding: 0.576rem 0;\n  position: absolute !important;\n  left: 28px;\n  bottom: 26px;\n  color: #fff;\n  font-size: 17px;\n  line-height: 17px;\n  text-align: center; }\n\n.creditResult .next::before {\n  border: none !important; }\n\n.creditResult .am-button-disabled {\n  background: #BDBDBD; }\n\n.creditResult .am-activity-indicator-content {\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0);\n  border-radius: 0px; }\n\n.creditResult .am-activity-indicator-spinner {\n  background-image: url(" + escape(__webpack_require__(333)) + ");\n  width: 86px;\n  height: 86px;\n  background-size: 100%;\n  border-radius: 8px; }\n\n.loader_wrap {\n  width: 118px;\n  height: 118px;\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  margin: -47px 0 0 -59px;\n  border-radius: 14px;\n  background-color: #171717;\n  font-size: 14px;\n  display: flex;\n  flex-flow: column;\n  justify-content: center;\n  align-items: center; }\n\n.loader_img {\n  width: 25px;\n  height: 25px;\n  background-image: url(" + escape(__webpack_require__(334)) + ");\n  background-repeat: no-repeat;\n  background-size: cover;\n  margin-bottom: 10px; }\n\n.loader_text {\n  position: relative;\n  bottom: -26px;\n  color: #fff; }\n", ""]);
