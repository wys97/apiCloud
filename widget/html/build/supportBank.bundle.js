...
var _supportBank = __webpack_require__(558);

var _supportBank2 = _interopRequireDefault(_supportBank);
...
var SupportBank = function (_React$Component) {
  (0, _inherits3.default)(SupportBank, _React$Component);

  function SupportBank(props) {
    (0, _classCallCheck3.default)(this, SupportBank);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SupportBank.__proto__ || (0, _getPrototypeOf2.default)(SupportBank)).call(this, props));

    _this.getDate = function () {
      var that = _this;
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("supportBank"),
          method: "post",
          dataType: "json",
          headers: {
  ...
  (0, _createClass3.default)(SupportBank, [{
    ...
    value: function componentWillMount() {
      ...
      _supportBank2.default.supportBank(this.state.bankCode).then(function (res) {
...
SupportBank.displayName = "SupportBank";
SupportBank.propTypes = {};
SupportBank.defaultProps = {};
exports.default = SupportBank;


_reactDom2.default.render(_react2.default.createElement(SupportBank, null), document.getElementById("supportBank"));
 ...
 * 支持银行
 */
var supportBank = exports.supportBank = function () {
  ...
  return function supportBank(_x) {
