...
var AddBankCardAuth = function (_React$Component) {
  (0, _inherits3.default)(AddBankCardAuth, _React$Component);

  function AddBankCardAuth(props) {
    (0, _classCallCheck3.default)(this, AddBankCardAuth);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddBankCardAuth.__proto__ || (0, _getPrototypeOf2.default)(AddBankCardAuth)).call(this, props));

    _this.authCode = function () {
      //验证码手机不能为空
      if (_this.state.phone !== "" && _this.state.smsCode !== "") {
        _this.setState({
          disabled: false
        });
      } else {
    ...
    _this.getCode = function () {
      ...
      var data = {
        ...
        bankCardNo: _this.state.cardNo
      };
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("preSign"),
          method: "post",
          dataType: "json",
          headers: {
    ...
    _this.tiedCard = function () {
      var that = _this;
      var data = {
        smsCode: _this.state.smsCode,
        codeType: "BIND_CARD",
        bankCode: _this.state.detail.bankCode,
        bankCardType: _this.state.detail.cardTypeName,
        bankCard: _this.state.detail.cardNo,
        phone: _this.state.phone,
        isCredit: 1
      };
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("bindBankCard"),
          method: "post",
          dataType: "json",
          headers: {
            "Content-Type": "application/json",
  ...
  (0, _createClass3.default)(AddBankCardAuth, [{
    ...
    value: function componentWillMount() {
      ...
      window.apiready = function () {
        ...
        that.setState({
          ...
          list: window.api.pageParam.detail.bankName + " " + window.api.pageParam.detail.cardTypeName + " " + window.api.pageParam.detail.cardNo,
  ...
  return AddBankCardAuth;
}(_react2.default.Component);

AddBankCardAuth.displayName = "AddBankCardAuth";
AddBankCardAuth.propTypes = {};
AddBankCardAuth.defaultProps = {};
exports.default = AddBankCardAuth;

_reactDom2.default.render(_react2.default.createElement(AddBankCardAuth, null), document.getElementById("addBankCardAuth"));
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.addBankCardAuth {\n  background: #fff;\n  height: 100%; }\n  .addBankCardAuth .am-list .am-list-item {\n    height: 52px; }\n    .addBankCardAuth .am-list .am-list-item .am-list-content {\n      color: #3f4850; }\n    .addBankCardAuth .am-list .am-list-item .am-list-extra {\n      color: #444d54; }\n    .addBankCardAuth .am-list .am-list-item .am-list-line {\n      margin-right: 15px;\n      padding: 0; }\n      .addBankCardAuth .am-list .am-list-item .am-list-line .am-input-label {\n        color: #3f4850; }\n    .addBankCardAuth .am-list .am-list-item .am-input-control {\n      color: #bdbdbd;\n      letter-spacing: -0.34px; }\n      .addBankCardAuth .am-list .am-list-item .am-input-control input {\n        text-align: right;\n        color: #444d54; }\n  .addBankCardAuth .am-list-body {\n    border-bottom: none; }\n    .addBankCardAuth .am-list-body .bankCard .am-list-line {\n      position: relative;\n      border-bottom: 1px solid #ddd; }\n      .addBankCardAuth .am-list-body .bankCard .am-list-line .am-input-label .coundDown {\n        width: 3.41333rem;\n        height: 30px;\n        position: absolute;\n        right: 0;\n        top: 10px;\n        border: 1px solid #e0514c;\n        background: #fff !important;\n        border-radius: 4px;\n        color: #e0514c;\n        text-align: center; }\n        .addBankCardAuth .am-list-body .bankCard .am-list-line .am-input-label .coundDown span {\n          display: block;\n          font-size: 14px;\n          line-height: 14px;\n          padding: 0.34133rem 0;\n          height: 14px; }\n    .addBankCardAuth .am-list-body .bankCard .am-input-control {\n      margin-right: 105px;\n      color: #bdbdbd;\n      letter-spacing: -0.34px; }\n      .addBankCardAuth .am-list-body .bankCard .am-input-control input {\n        text-align: right;\n        color: #444d54; }\n    .addBankCardAuth .am-list-body .cardType .am-list-extra {\n      flex-basis: 70%; }\n  .addBankCardAuth .readTheAgreement {\n    position: absolute;\n    bottom: 84px;\n    width: 100%;\n    font-size: 12px;\n    line-height: 17px;\n    color: #454f55;\n    text-align: center; }\n    .addBankCardAuth .readTheAgreement .my-radio {\n      width: 100%;\n      text-align: center;\n      display: block; }\n      .addBankCardAuth .readTheAgreement .my-radio .am-radio {\n        padding: 1px;\n        border: 1px solid #e0514c;\n        border-radius: 1.41px;\n        margin-right: 5px;\n        width: 10px;\n        height: 10px; }\n        .addBankCardAuth .readTheAgreement .my-radio .am-radio .am-radio-inner:after {\n          border-color: #e0514c;\n          top: -6.5px;\n          right: 2px; }\n        .addBankCardAuth .readTheAgreement .my-radio .am-radio b {\n          color: #e0514c; }\n  .addBankCardAuth .next {\n    display: block;\n    background: #e1514c;\n    height: 1.87733rem;\n    border: none;\n    border-radius: 16px 0 16px 0;\n    padding: 0.576rem 0;\n    color: #fff;\n    font-size: 17px;\n    line-height: 17px;\n    text-align: center;\n    margin: 2.56rem 1.19467rem; }\n  .addBankCardAuth .next::before {\n    border: none !important; }\n  .addBankCardAuth .am-button-disabled {\n    background: #BDBDBD; }\n  .addBankCardAuth .caution {\n    color: #e0514c;\n    margin-top: 9px;\n    margin-left: 16px;\n    font-size: 12px;\n    line-height: 17px; }\n  .addBankCardAuth .error {\n    color: #e1514c;\n    width: 100%;\n    text-align: center;\n    font-size: 14px;\n    margin-top: 0.21333rem; }\n\n.am-list-item .am-list-line .am-list-content, .am-list-item .am-input-control input {\n  font-size: 14px; }\n\n.am-list-item .am-list-line .am-list-extra, .am-list-item .am-input-label {\n  font-size: 14px; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444d54; }\n", ""]);
