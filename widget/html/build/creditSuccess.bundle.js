...
var CreditSuccess = function (_React$Component) {
  (0, _inherits3.default)(CreditSuccess, _React$Component);

  function CreditSuccess(props) {
    (0, _classCallCheck3.default)(this, CreditSuccess);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CreditSuccess.__proto__ || (0, _getPrototypeOf2.default)(CreditSuccess)).call(this, props));
    ...
    _this.getOk = function () {
      ...
      //         window.api.closeFrame({ name: "creditSuccess" })
      //       }
      //     },
      //     {
      //       text: '去设置', onPress: () => {
  ...
  (0, _createClass3.default)(CreditSuccess, [{
...
CreditSuccess.displayName = "creditSuccess";
CreditSuccess.propTypes = {};
CreditSuccess.defaultProps = {};
exports.default = CreditSuccess;

_reactDom2.default.render(_react2.default.createElement(CreditSuccess, null), document.getElementById("creditSuccess"));
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.creditSuccess .succeed {\n  border-top: 1px solid #efefef; }\n  .creditSuccess .succeed img {\n    display: block;\n    width: 2.64533rem;\n    height: 2.64533rem;\n    margin: 3.41333rem 0 1.024rem 6.656rem; }\n  .creditSuccess .succeed h2 {\n    font-size: 16px;\n    color: #606060;\n    letter-spacing: -0.39px;\n    text-align: center;\n    line-height: 22px;\n    margin-bottom: 12px; }\n  .creditSuccess .succeed p {\n    font-size: 14px;\n    color: #909090;\n    letter-spacing: -0.34px;\n    text-align: center;\n    line-height: 20px; }\n\n.creditSuccess .next {\n  display: block;\n  background: #e1514c;\n  width: 13.61067rem;\n  height: 1.87733rem;\n  border: none;\n  border-radius: 16px 0 16px 0;\n  padding: 0.576rem 0;\n  position: absolute !important;\n  left: 28px;\n  bottom: 26px;\n  color: #fff;\n  font-size: 17px;\n  line-height: 17px;\n  text-align: center; }\n\n.creditSuccess .next::before {\n  border: none !important; }\n\n.creditSuccess .am-button-disabled {\n  background: #BDBDBD; }\n", ""]);
