...
var ContactsList = function (_React$Component) {
  (0, _inherits3.default)(ContactsList, _React$Component);

  function ContactsList(props) {
    (0, _classCallCheck3.default)(this, ContactsList);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ContactsList.__proto__ || (0, _getPrototypeOf2.default)(ContactsList)).call(this, props));

    _this.getDate = function () {
      var that = _this;
      if (window.api) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("contacInfoList"),
          method: "post",
          dataType: "json",
          headers: {
          ...
          if (ret) {
            ...
            if (err.msg !== '') {
              _toast2.default.info(err.msg, 4);
            } else {
              _toast2.default.info(ret.message, 4);
            }
          }
        });
      }
    ...
    _this.deleteData = function (item) {
      //删除联系人
      var contactId = item.contactId;
      var that = _this;
      alert('', '确定删除【' + item.contactName + '】吗？', [{
        text: '删除', onPress: function onPress() {
          window.api.ajax({
            url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("contacInfoDelete") + contactId,
            method: "post",
            dataType: "json",
            headers: {
              "Content-Type": "application/json",
    ...
    _this.goContactsAmend = function (index) {
      // 修改联系人
    ...
    _this.getDetail = function (index) {
      var detail = {
        contactRelationText: _this.state.data[index].contactRelationText,
        contactName: _this.state.data[index].contactName,
        contactPhone: _this.state.data[index].contactPhone
      };
      _this.setState({
        detail: detail,
        visible: true
    ...
    _this.goCreditResult = function () {
      var contactRelationText = 0;
      ...
      if (_this.state.data.length < 2) {
        _toast2.default.info("请至少添加两位联系人！", 3);
      } else if (contactRelationText === 0) {
        _toast2.default.info("请至少添加一位亲人！", 3);
      } else {
        window.api.openFrame({
          name: "creditResult",
  ...
  (0, _createClass3.default)(ContactsList, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          data.map(function (item, index) {
            return _react2.default.createElement(
              "div",
              { key: index, className: "list-title" },
              _react2.default.createElement(
                "div",
                {
                  className: "l_text",
                  onClick: function onClick() {
                    _this2.getDetail(index);
                  }
                },
                _react2.default.createElement(
                  "span",
                  { className: "relation" },
                  item.contactRelationText
                ),
                _react2.default.createElement(
                  "span",
                  { className: "name" },
              ...
              _react2.default.createElement(
                ...
                (0, _stringify2.default)(item.contactPhone).substring(1, 4) + '****' + (0, _stringify2.default)(item.contactPhone).substring(9, 12)
              ),
              _react2.default.createElement(
                "div",
                { className: "r_img" },
          ...
          data.length === 10 ? _react2.default.createElement(
            "div",
            { className: "warn" },
            "*\u4EC5\u80FD\u6DFB\u52A010\u4E2A\u8054\u7CFB\u4EBA\uFF0C\u76EE\u524D\u5DF2\u8FBE\u4E0A\u9650"
          ) : null
...
_reactDom2.default.render(_react2.default.createElement(ContactsList, null), document.getElementById("contactsList"));
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
// module
exports.push([module.i, ".am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.contactsList {\n  position: relative; }\n  .contactsList .am-navbar-right img {\n    height: 22px; }\n  .contactsList .list {\n    display: block;\n    background: #fff;\n    border-top: 1px solid #ededed; }\n    .contactsList .list .list-title {\n      display: flex;\n      align-items: center;\n      height: 52px;\n      margin: 0 15px;\n      border-bottom: 1px solid #ededed;\n      justify-content: space-between; }\n      .contactsList .list .list-title .l_text {\n        display: flex;\n        align-items: center; }\n      .contactsList .list .list-title .relation {\n        background: #ffffff;\n        border: 1px solid #e1514c;\n        border-radius: 2px;\n        font-size: 10px;\n        color: #e1514c;\n        line-height: 15px; }\n      .contactsList .list .list-title .name {\n        font-size: 14px;\n        color: #3f4850;\n        line-height: 52px;\n        margin-left: 10px; }\n      .contactsList .list .list-title .phone {\n        font-size: 14px;\n        color: #3f4850;\n        line-height: 52px; }\n      .contactsList .list .list-title .r_img {\n        display: flex;\n        align-items: center; }\n      .contactsList .list .list-title .amend {\n        width: 14px;\n        height: 16px;\n        margin: 10px 10px; }\n    .contactsList .list .warn {\n      font-size: 12px;\n      color: #e1514c;\n      letter-spacing: -0.29px;\n      text-align: center;\n      line-height: 17px;\n      margin-top: 10px; }\n  .contactsList .next {\n    display: block;\n    background: #e1514c;\n    width: 13.61067rem;\n    height: 1.87733rem;\n    border: none;\n    border-radius: 16px 0 16px 0;\n    padding: 0.576rem 0;\n    position: absolute !important;\n    left: 28px;\n    bottom: 26px;\n    color: #fff;\n    font-size: 17px;\n    line-height: 17px;\n    text-align: center; }\n    .contactsList .next img {\n      display: inline-block;\n      height: 14px;\n      margin-right: 5px; }\n  .contactsList .next::before {\n    border: none !important; }\n  .contactsList .am-button-disabled {\n    background: #BDBDBD; }\n\n.detail-cpm .am-modal-transparent {\n  width: 12.8rem;\n  height: 7.76533rem; }\n\n.detail-cpm .detail {\n  padding-top: 30px; }\n  .detail-cpm .detail p {\n    font-size: 14px;\n    color: #444d54;\n    line-height: 30px; }\n    .detail-cpm .detail p span {\n      margin-left: 15px; }\n  .detail-cpm .detail b {\n    font-size: 12px;\n    color: #e1514c;\n    line-height: 17px;\n    margin-top: 23px; }\n\n.hint {\n  color: #E0514C;\n  font-size: 12px;\n  padding: 10px 15px;\n  line-height: 17px; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444D54; }\n\n.am-modal-transparent .am-modal-content .am-modal-body {\n  padding: 25px 15px 30px; }\n\n.am-modal-body {\n  font-size: 16px;\n  color: #444D54; }\n\n.am-modal-button-group-h .am-modal-button {\n  font-size: 16px;\n  color: #444D54; }\n\n.am-modal-button-group-h .am-modal-button {\n  font-size: 16px;\n  color: #444D54; }\n", ""]);
