...
var SetPassword = function (_React$Component) {
  (0, _inherits3.default)(SetPassword, _React$Component);

  function SetPassword(props) {
    (0, _classCallCheck3.default)(this, SetPassword);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SetPassword.__proto__ || (0, _getPrototypeOf2.default)(SetPassword)).call(this, props));
    ...
    _this.goSkip = function (value) {
      var from = window.api.pageParam.from;
      var backtrack = window.api.pageParam.backtrack;
      var marginBottom = "";
      if (from === "userInfo") {
    ...
    _this.succeed = function () {
      var uid = window.api.pageParam.uid;
      var from = window.api.pageParam.from;
      var setId = window.api.pageParam.setId;
    ...
    _this.next = function () {
      ...
      if (window.api.pageParam.uid) {
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("passwordSetting"),
          method: "post",
          dataType: "json",
          headers: {
          ...
          if (ret.code === "200") {
            ...
            if (err.msg !== "") {
              ...
              _toast2.default.info(err.body.message, 4);
            } else {
        ...
        window.api.ajax({
          url: (0, _linkConfig.getLink)() + (0, _linkConfig.getApi)("loginPasswordSetting"),
          method: "post",
          dataType: "json",
          headers: {
            "Content-Type": "application/json",
  ...
  (0, _createClass3.default)(SetPassword, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _navBar2.default,
          {
            ...
            rightContent: !this.state.skipNo && _react2.default.createElement(
              "p",
        ...
        this.state.type === false ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.visible === false ? _react2.default.createElement("img", { className: "eye", src: __webpack_require__(469) }) : _react2.default.createElement("img", {
              className: "eye",
          ...
          "div",
          { className: "succeed" },
          _react2.default.createElement("img", { src: __webpack_require__(335), alt: "" }),
          _react2.default.createElement(
            "p",
            null,
            "\u5BC6\u7801\u8BBE\u7F6E\u6210\u529F"
...
_reactDom2.default.render(_react2.default.createElement(SetPassword, null), document.getElementById("setPassword"));
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept(569, function() {
			var newContent = __webpack_require__(569);
...
module.exports = __webpack_require__.p + "fe679c9f47159d9a9ca609d5c34b0f87.png";
...
// module
exports.push([module.i, ".setPassword .am-toast-notice-content .am-toast-text {\n  background-color: rgba(0, 0, 0, 0.8); }\n\n.setPassword .am-list .am-list-body .password {\n  height: 55px;\n  position: relative; }\n  .setPassword .am-list .am-list-body .password .am-list-line {\n    margin-right: 15px; }\n    .setPassword .am-list .am-list-body .password .am-list-line .am-list-line::after {\n      width: 14.67733rem;\n      margin-left: 0.64rem; }\n    .setPassword .am-list .am-list-body .password .am-list-line .am-input-label {\n      font-size: 14px;\n      color: #454f55;\n      letter-spacing: 0;\n      line-height: 20px; }\n    .setPassword .am-list .am-list-body .password .am-list-line .am-input-control {\n      margin-right: 3px; }\n      .setPassword .am-list .am-list-body .password .am-list-line .am-input-control input {\n        text-align: right;\n        font-size: 14px;\n        color: #ababab;\n        letter-spacing: -0.34px; }\n\n.setPassword .am-list .am-list-body .visible {\n  position: absolute;\n  top: 16px;\n  right: 13px; }\n  .setPassword .am-list .am-list-body .visible .eye {\n    width: 0.81067rem;\n    display: inline-block; }\n\n.setPassword .am-list .am-list-body::before {\n  height: 0; }\n\n.setPassword .am-list .am-list-body::after {\n  height: 0; }\n\n.setPassword .next {\n  display: block;\n  background: #e1514c;\n  height: 1.87733rem;\n  border: none;\n  border-radius: 22px 0 22px 0;\n  padding: 0.576rem 0;\n  margin: 5.16267rem 1.19467rem 0 1.19467rem;\n  color: #fff;\n  font-size: 17px;\n  line-height: 17px;\n  text-align: center; }\n\n.setPassword .next::before {\n  border: none !important; }\n\n.setPassword .am-button-disabled {\n  background: #BDBDBD; }\n\n.error {\n  color: #e1514c;\n  width: 100%;\n  text-align: center;\n  font-size: 14px;\n  margin-top: 0.21333rem; }\n\n.succeed {\n  display: block; }\n  .succeed img {\n    display: block;\n    width: 2.64533rem;\n    height: 2.64533rem;\n    margin: 3.41333rem 6.656rem 1.024rem 6.656rem; }\n  .succeed p {\n    font-size: 16px;\n    color: #606060;\n    letter-spacing: -0.39px;\n    text-align: center;\n    line-height: 22px; }\n\n.am-navbar-light .am-navbar-title {\n  color: #444D54; }\n", ""]);
